# Plonky2 & more (Pearl Fork)

This is the Pearl fork of Plonky2, a SNARK implementation based on techniques from PLONK and FRI. It has since expanded to include tools such as Starky, a highly performant STARK implementation.

> **Note:** This fork is maintained by the Pearl Team. The upstream Plonky2 project by Polygon Zero has been deprecated in favor of [Plonky3](https://github.com/Plonky3/Plonky3). This Pearl fork continues to be actively maintained and developed.
...
The original Plonky2 code was audited prior to its `v1.0.0` release. The audit reports and findings are available in the [audits](./audits/) folder of this repository.
