...
>(
    ...
    let openings = openings_fn(plonk_zeta);
    ...
    ProofWithPublicInputs<F, C, D>
{
    ...
    pub fn get_challenges(
        ...
        let Proof {
            ...
            quotient_polys_random_cap: quotient_polys_cap,
            openings,
            opening_proof:
                FriProof {
                    commit_phase_merkle_caps,
