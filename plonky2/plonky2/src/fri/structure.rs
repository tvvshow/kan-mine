...
/// Index of the zeta openings batch. The zeta batch is always first (idx = 0)
/// and is where the randomness polynomial is added in zero-knowledge (hiding) mode.
pub const ZETA_BATCH_IDX: usize = 0;
pub const ZETA_NEXT_BATCH_IDX: usize = 1;
