...
pub trait Field64: Field {
    ...
    /// Does not embed negative numbers to respect field operations. Marked unsafe for this reason.
    // TODO: Move to `Field`.
    #[inline]
    unsafe fn from_canonical_i64(n: i64) -> Self {
        Self::from_canonical_u64(n as u64)
    }
